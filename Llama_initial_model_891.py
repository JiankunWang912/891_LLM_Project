...
output_dir = f"./891_Project_results/prompt{args.prompt_id}"
...
dataset_name_tr = "./dataset/Adv_cancer_train_70.csv"
...
def fine_tune(model,
    ...
    preds_df.to_csv(f"./891_Project_results/prompt{args.prompt_id}/preds.csv")
    true_labels_df = pd.DataFrame(np.array(predictions.label_ids))
    true_labels_df.to_csv(f"./891_Project_results/prompt{args.prompt_id}/true_labels.csv")
